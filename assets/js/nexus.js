...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // ============================================================
    // DASHBOARD - Charts (requires Chart.js) - FIXED FOR DARK MODE
    // ============================================================
    ...
    function initCharts() {
        ...
        const gridColor = isDark ? '#2a3346' : '#e9edf4';
    ...
    window.updateCharts = function() {
        ...
        if (userChartInstance) {
            ...
            userChartInstance.options.scales.y.grid.color = gridColor;
            userChartInstance.options.scales.y.ticks.color = textColor;
            userChartInstance.options.scales.x.ticks.color = textColor;
        ...
        if (orderChartInstance) {
            ...
            orderChartInstance.options.plugins.legend.labels.color = textColor;
